...
exports.formatCompressed = formatCompressed;
function compressHistory(entries) {
    ...
    const allFiles = [...new Set(entries.flatMap(e => e.files_changed)
            .filter(f => !f.startsWith('agentos/')))].slice(0, 20);
    return {
...
function formatCompressed(history) {
